 ...
 * 操作 房屋详细服务层接口
 * */
public interface IHouseBedService {
    //对出租方式表的操作
    //查询
    ...
    //对房屋户型表的操作
    //查询
    Houseapartment select_houseApartment(String haiid);
    //添加
    ...
    //根据房源id查询房屋详细
    Homeallinformation select_houseDetails(String haiId);

    //根据房屋id查询houseDetails表是否存在
    Housedetails selct_houseDetails_haiId(String haiId);
    //根据房屋详细表id删除
    int delete_houseBed(int hdId);
}
