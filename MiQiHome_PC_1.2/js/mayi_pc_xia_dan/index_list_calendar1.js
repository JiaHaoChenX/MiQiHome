   ...
   getSelectedDate: function() {
    ...
    _DELEGATE: {
        ...
        'triggerNodeClick': function(e) {
			...
			if(citypinyin=="beijing"&&(user==null||user=="")){
        ...
        for(var i = 0; i < rows; i++) {
            ...
            for(var j = 0; j <= 6; j++) {
                ...
                var sdate=
					...
					if(sdate.indexOf('8折')!=-1){
						var begin_index =sdate.indexOf('8折');
						var end_index =sdate.indexOf('</a');
						sdate=sdate.substring(0,begin_index-1)+' style="background-color:#ff7043;color:grey;font-weight:100">8折'+sdate.substring(end_index,sdate.length);
					} 
    ...
    CALENDAR_TEMPLATE: '<div id="{bounding_box_id}" class="calendar-bounding-box">' +
                            '<div class="container">' +
                                ...
                                '<div class="content-box">' +
                                    '<div class="arrow">' +
                                        '<div class="close-btn {delegate_click}"  id="clearSelect">清空日期</div>' +
