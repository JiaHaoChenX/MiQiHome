 ...
 *
 * */
public interface IHouseFacilitiesReflectDao {
    //对设施服务表进行的操作
    //查询设施服务表
    ...
    //查询总数
    /*int select_housefacilitiesdetails_count(@Param("hfId") String hfId,@Param("page") int page,@Param("limit") int limit);*/
    ...
    //删除设施服务对应表信息
    int delete_houseFacilitiesReflect(@Param("haiId") String haiId);
    //根据房源id查询设施服务
    List<HouseFacilitiesReflect> select_HouseFacilitiesDetails_haiId(@Param("haiId")String haiId);
}
