	...
	jRange.prototype = {
		...
		template: '<div class="slider-container">\
			<div class="back-bar">\
                ...
                <div class="pointer high"></div><div class="pointer-label more">456789</div>\
		...
		setValue: function(value) {
			...
			if (this.isSingle()) {
				this.setPosition(this.lowPointer, prc[1]);
				this.setPosition(this.highPointer, prc[1]);
			} else {
				this.setPosition(this.lowPointer, prc[0]);
				this.setPosition(this.highPointer, prc[1]);
			}
			// 闄堣秴娣诲姞锛岃В鍐硍ap涓や釜閮芥槸鏈€澶у€兼椂涓嶈兘鎷栨嫿闂
			if (values.length == 2 && values[0] == values[1] && values[0] == 1001) {
				this.lowPointer.prevObject[0].style.zIndex=4;
			}
		},
